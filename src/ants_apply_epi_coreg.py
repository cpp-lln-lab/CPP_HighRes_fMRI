...
for subject in subjectList:
    ...
    pattern = "sub-{subject}[/ses-{session}]/roi/sub-{subject}[_ses-{session}]_acq-r0p375_hemi-R_space-EPIT1w_label-rightLateralPTV1_mask.nii"
    entities = layout.parse_file_entities(lPTvis1[0])
    filename = layout.build_path(entities, pattern, validate=False)
    ...
    pattern = "sub-{subject}[/ses-{session}]/roi/sub-{subject}[_ses-{session}]_acq-r0p375_hemi-R_space-EPIT1w_label-rightLateralPTV2_mask.nii"
    entities = layout.parse_file_entities(lPTvis2[0])
    filename = layout.build_path(entities, pattern, validate=False)
