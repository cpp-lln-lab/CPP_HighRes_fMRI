...
NumVol=`3dinfo -nv Nulled_sub-pilot005_ses-002_task-gratingBimodalMotion_run-001_vaso.nii`
3dcalc -a Nulled_sub-pilot005_ses-002_task-gratingBimodalMotion_run-001_vaso.nii'[2..'`expr $NumVol - 2`']' \
   -b  rNot_Nulled_sub-pilot005_ses-002_task-gratingBimodalMotion_run-001_bold.nii'[2..'`expr $NumVol - 2`']' -expr 'a+b' -prefix combined.nii -overwrite
